...
let fake_div = `
  <div class='chat-fake'> 
    <div class='fake-img'>
      <img src='imgs/alert.svg'></img>
    </div>
    <div class='fake-text'>
      <em>THIS MIGHT NOT BE TRUE.</em>
      <br>
      <a href=''>Know more</a>
    </div>
  </div>
...
class ChatArea extends React.Component {
  render() {
    ...
    return React.createElement(
            ...
            if (isFake(msg)){
              return (
                React.createElement('div', 
                  ...
                  React.createElement('div', { className:'chat-text-other', dangerouslySetInnerHTML: { __html: fake_div + marked(msg) } }))
              )
            } else {
              return (
                React.createElement('div', 
      ...
      React.createElement(
        'div',
        { id: 'chat-status-msg', dangerouslySetInnerHTML: { __html: marked(this.props.status) } },
        null,
      )
    );
  }
